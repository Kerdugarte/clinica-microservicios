package com.clinica.auth_service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> manejarAuthException(AuthException ex) {
        Map<String, Object> response = construirRespuesta(HttpStatus.UNAUTHORIZED, ex.getMessage());
